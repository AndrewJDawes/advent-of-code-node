...
import { execute, ExecutionContext, jnz } from './common.js';

describe('Solution201612', () => {
    describe('execute', () => {
        it('accepts an initialized map of registers', () => {
            const registers = new Map();
            registers.set('a', 42);
            const result = execute(['inc a'], registers);
